    ...
    var runDemoJS = function () { 
	   ...
	   $('.toggle-color-swap').on('click',function() {
		   ...
		   if (swapColor === 'bg-white') {
				...
				navbarLogo.attr('src', '/static/img/logos/header-logo.png');
		   } else {
			   navbar.removeClass(colors).addClass(swapColor + ' navbar-white-text');
			   navbarLogo.attr('src', '/static/img/logos/header-logo_light.png');
		   }
	   });	
        ...
        $(window).load(function() {
			...
			var scripts = {
				...
				image1: 		 '/static/img/stock/splash/1.jpg',
				image2:		     '/static/img/stock/splash/2.jpg',
				image3: 		 '/static/img/stock/splash/3.jpg',
				image4: 		 '/static/img/stock/splash/4.jpg',
				// HIGH PRIORITY
				...
				mpopup: 		 '/static/vendor/plugins/mfpopup/jquery.magnific-popup.min.js',
				chosen:		  	 '/static/vendor/plugins/chosen/chosen.jquery.js',
				...
				// FORMS TOOLS
				holder: 	     '/static/vendor/bootstrap/plugins/holder/holder.js',
				tagmanager:      '/static/vendor/plugins/tags/tagmanager.js',
				gritter:         '/static/vendor/plugins/gritter/jquery.gritter.min.js',
				ladda:           '/static/vendor/plugins/ladda/ladda.min.js',
				paginator:		 '/static/vendor/bootstrap/plugins/paginator/bootstrap-paginator.js',
				...
				charts:       	 '/static/js/pages/charts.js',
				...
				jcrop: 			 '/static/vendor/plugins/imagecrop/jquery.Jcrop.min.js',
				imagezoom: 		 '/static/vendor/plugins/imagezoom/jquery.elevatezoom.min.js',
				sketchpad:       '/static/vendor/plugins/notepad/wPaint.min.js',
				fileupload:      '/static/vendor/bootstrap/plugins/fileupload/fileupload.js',
			};	
